...
describe('calculadora: dígitos', function() {
  this.timeout(30000)
  let driver
  let vars
  ...
  it('calculadora: dígitos', async function() {
    ...
    await driver.findElement(By.css(".btnDigito:nth-child(14)")).click()
    assert(await driver.findElement(By.css(".Pantalla")).getText() == "987654321.1")
    ...
    await driver.findElement(By.css(".btnOperar:nth-child(4)")).click()
    await driver.findElement(By.css(".btnOperar:nth-child(4)")).click()
    assert(await driver.findElement(By.css(".Pantalla")).getText() == "98765432")
